...
if (!hasPermission('room_service') && !hasPermission('bookings') && !hasPermission('checkout') && !hasPermission('report')) {
...
<div class="no-print" style="text-align: center;">
    ...
    <button onclick="window.close()" style="padding: 8px 20px; border-radius: 5px; cursor: pointer; font-family: 'Noto Sans Lao', 'Noto Sans Lao Looped', sans-serif;">ປິດ</button>
</div>

<div class="receipt">
    <div class="header">
        <div class="hotel-name"><?php echo $hotel_name; ?></div>
        <div style="font-size: 11px; color: #000;"><?php echo $hotel_address; ?></div>
        <div style="font-size: 11px; color: #000;">Tel: <?php echo $hotel_phone; ?></div>
        <div class="divider"></div>
        <div style="font-weight: bold; font-size: 14px; color: #000;">ບິນຄ່າອາຫານ (FOOD BILL)</div>
        <div style="font-size: 12px; color: #000; font-weight: bold; margin-top: 2px;">ຫ້ອງ: <?php echo $booking['room_number']; ?></div>
    </div>
